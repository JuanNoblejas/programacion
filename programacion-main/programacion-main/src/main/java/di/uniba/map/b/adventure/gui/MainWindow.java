...
public class MainWindow extends JFrame implements GameEngine.EngineListener {
    ...
    private void initUI() {
        ...
        pnlOxigeno.add(new JLabel("Oxygen: ") {{
        ...
        JLabel lblPausa = new JLabel("GAME PAUSED");
        ...
        JButton btnNorte = createDirButton("\u2191 North", "north");
        JButton btnSur   = createDirButton("\u2193 South", "south");
        JButton btnEste  = createDirButton("East \u2192", "east");
        JButton btnOeste = createDirButton("\u2190 West", "west");
        ...
        pnlAcciones.add(createActionButton("\uD83D\uDC41 Look",      "look",      new Color(60, 100, 140)));
        pnlAcciones.add(createActionButton("\u270B Take",             "take",      new Color(60, 120, 60)));
        pnlAcciones.add(createActionButton("\u2699 Use",              "use",       new Color(140, 120, 40)));
        pnlAcciones.add(createActionButton("\uD83C\uDF92 Inventory",  "inv",       new Color(100, 60, 140)));
        pnlAcciones.add(createActionButton("\uD83D\uDCBB Hack",      "hack",      new Color(140, 50, 50)));
        pnlAcciones.add(createActionButton("\uD83D\uDCBE Save",      "save",      new Color(50, 100, 100)));
        pnlAcciones.add(createActionButton("\uD83D\uDCC2 Load",      "load",      new Color(50, 100, 100)));
        pnlAcciones.add(createActionButton("\u2753 Help",             "help",      new Color(80, 80, 100)));
    ...
    private JButton createActionButton(String text, String comando, Color bgColor) {
        ...
        btn.addActionListener(e -> {
            ...
            if (comando.equals("take") || comando.equals("use")) {
                // Pause timer while dialog is open
                engine.pausarTimer();
                String arg = JOptionPane.showInputDialog(
                    this,
                    "Enter the object name for '" + comando + "':",
    ...
    @Override
    public void onInventoryChange(Contenitore<ObjetoJuego> inventory) {
        modelInventario.clear();
        for (ObjetoJuego item : inventory.getElementos()) {
