...
public class GameOverWindow extends JFrame {
    ...
    public GameOverWindow(boolean win) {
        ...
        // Titulo grande
        JLabel lblTitulo = new JLabel(win ? "MISSION COMPLETE" : "GAME OVER");
        ...
        String mensajeTexto;
        if (win) {
            mensajeTexto = "<html><center>You managed to repair the escape module<br>"
                    + "and leave the space station.<br><br>"
                    + "Earth awaits you, astronaut.</center></html>";
        } else {
            mensajeTexto = "<html><center>The oxygen has run out...<br>"
        ...
        JButton btnNuevoJuego = createStyledButton("New Game", new Color(0, 120, 80));
        btnNuevoJuego.addActionListener((ActionEvent e) -> {
            dispose();
            SwingUtilities.invokeLater(() -> new MainWindow().setVisible(true));
        });

        JButton btnSalir = createStyledButton("Quit", new Color(120, 30, 30));
